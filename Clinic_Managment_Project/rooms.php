...
<html>
    ...
    <div class="container my-5">
        <button class="mb-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
            <a href = "Add Details/add_rooms.php" class="text-light">Add</a>
        </button>
                    ...
                    if($result->rowCount()>0){
                        while($row = $result->fetch())
                        {
                            ?>
                                ...
                                <td><?php echo $row['occupied_by']; ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="Update/edit_rooms.php?emp_id=<?php echo $row['room_no'];?>">Edit</a></button>
                                </td>
                                <td>
                                    <button class="ml-2 bg-red-500 hover:bg-red-700 text-black font-bold py-2 px-4 border border-blue-700 rounded"> 
                                    <a href="Delete/delete_rooms.php?deleteid=<?php echo $row['room_no'];?>" onclick = "return confirm('are you sure to delete');">Delete</a></button>
                                </td>
